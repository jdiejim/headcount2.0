...
describe('DistrictRepository iteration 1 - part 1', () =>  {
  ...
  test('it should return a number rounded to the nearest thousandth', () => {
    ...
    expect(district.getRoundedData(dataVal)).toBe(result);
  });

  test('it should return 0 if data is not a number (NaN)', () => {
    const dataVal = 'n/a';
    const result = 0;
  ...
  test('it should return an object template for a location', () => {
    const result = { location: 'Colorado', data: {}, info: [] };
